...
class Fixture_ThreeApplications {
  ...
  function __construct(){
    $this->fixtures = array(
      new Parserevent('newline',array (  'newline' => 'exten => 1,1,Answer()',  'number' => 1,)),
      ...
      new Parserevent('newline',array (  'newline' => 'exten => 1,2,Playback(\'tt-weasels\') ; Always funny',  'number' => 2,)),
      new Parserevent('extension',array (  'extension' => '1',)),
      ...
      new Parserevent('newline',array (  'newline' => 'exten => 1,3,Hangup()',  'number' => 3,)),
      new Parserevent('extension',array (  'extension' => '1',)),
